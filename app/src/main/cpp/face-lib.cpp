...
#else
#define LOG_TAG "BioDiary/Native"
...
Java_edu_bk_thesis_biodiary_core_face_NativeMethods_TrainFaces(JNIEnv, jobject, jlong addrImages,
                                                               jlong addrClasses) {
...
JNIEXPORT void JNICALL
Java_edu_bk_thesis_biodiary_core_face_NativeMethods_MeasureDist(JNIEnv *env, jobject,
                                                                jlong addrImage,
                                                                jfloatArray minDist,
                                                                jintArray minDistIndex,
                                                                jfloatArray faceDist,
                                                                jboolean useEigenfaces) {
    Facebase *pFacebase;
    if (useEigenfaces) {
