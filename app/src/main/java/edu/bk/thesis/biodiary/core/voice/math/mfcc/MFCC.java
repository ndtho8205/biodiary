package edu.bk.thesis.biodiary.core.voice.math.mfcc;

import edu.bk.thesis.biodiary.core.voice.math.fft.FFT;
...
public class MFCC
{
    ...
    private Matrix createDCTMatrix()
    {
        ...
        double w2 = Math.sqrt(
            2.0 / numberFilters);// Math.sqrt(2.0/numberFilters)*(Math.sqrt(2.0)/2.0);
