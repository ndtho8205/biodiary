package edu.bk.thesis.biodiary.core.voice.math.fft;

import edu.bk.thesis.biodiary.core.voice.math.window.HammingWindow;
import edu.bk.thesis.biodiary.core.voice.math.window.WindowFunction;
...
public final class FFT
{
    ...
    public FFT(int windowSize, WindowFunction windowFunction)
    {
        ...
        if (windowSize != (1 << ((int) Math.rint(Math.log(windowSize)
            ...
            throw new IllegalArgumentException(
                "Illegal FFT window size: " + windowSize + " is not power of 2");
        }
     ...
     * @param direction the direction of the Fourier transform (FORWARD or REVERSE)
     * @throws IllegalArgumentException if the length of the input data is not a power of 2
     */
