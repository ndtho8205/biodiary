package edu.bk.thesis.biodiary.core.voice.math.matrix;
...
import edu.bk.thesis.biodiary.core.voice.math.matrix.comp.CholeskyDecomposition;
import edu.bk.thesis.biodiary.core.voice.math.matrix.comp.LUDecomposition;
import edu.bk.thesis.biodiary.core.voice.math.matrix.comp.QRDecomposition;
import edu.bk.thesis.biodiary.core.voice.math.matrix.comp.SingularValueDecomposition;
...
public class Matrix implements Cloneable, Serializable
{
     ...
     *
     * @param rows A Vector<double[]> containing double[] items. Each double[]
    ...
    public Matrix abs()
    {
        Matrix result = new Matrix(m, n); // don't use clone(), as the values
     ...
     *
     * @param filename the name of the ascii file to create, e.g.
     *                 "C:\\temp\\matrix.ascii"
